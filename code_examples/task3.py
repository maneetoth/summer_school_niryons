...
# vision_pose = PoseObject(x = 0.535, y = -0.1650, z = 0.3154, roll = -0.184, pitch = 1.370, yaw = 2.300)
move_pose = PoseObject(x = 0.535, y = 0.2898550724637681, z = 0.07677201000815023, roll = -0.184, pitch = 1.370, yaw = 2.300)
    ...
    while True:
        ...
        if detection_result:
            ...
            if detection_status:
                ...
                if obj_found:
                    print(f"Picked {shape_ret} object of {color_ret} color.")
                else:
